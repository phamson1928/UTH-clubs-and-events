...
INSERT INTO event
  (id, name, description, status, event_image, "createdAt", date, "endDate", attending_users_number, max_capacity, registration_deadline, visibility, activities, location, "clubId", points, "proposalUrl", "checkInCode")
VALUES
