...
- [x] **Phân cấp vai trò trong CLB (Internal Roles)**
  ...
  - [x] **Frontend:** Trang quản lý vai trò cho thành viên trong dashboard của Club Owner.
...
- [x] **Quản lý Đề án & Tài liệu (Proposal Management)**
  ...
  - [x] **Frontend:** Form tạo sự kiện cho phép đính kèm file kế hoạch chi tiết để Admin duyệt.
...
- [x] **Hệ thống Thông báo (Notification System)**
  ...
  - [x] **Frontend:** Widget Thông báo (hình chuông) trên Navbar với trạng thái Đọc/Chưa đọc.
