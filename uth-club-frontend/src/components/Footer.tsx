      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-3">
            <div className="text-accent-foreground text-lg font-semibold">UTH Club System</div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link className="hover:text-accent-foreground transition-colors" to="/">
                    Home
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-3">
              <div className="text-accent-foreground font-medium">Dashboards</div>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link
                    className="hover:text-accent-foreground transition-colors"
